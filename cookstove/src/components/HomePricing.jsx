					...
					<div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
						<div className="p-8 sm:p-10 lg:flex-auto text-center">
							...
							<p className="mt-8 text-base leading-7 text-gray-600">
								...
								change your life forever! It's time to
								experience a whole new level of excitement as
								you navigate the intricate art of stove
								management. Who needs boring, mundane tasks when
								you can monitor your cooking appliances?
							</p>
						</div>
